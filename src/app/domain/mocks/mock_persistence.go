...
// Source: genesis-test/src/app/service (interfaces: NewsletterSender,EmailStorage,ExchangeChain,ExchangeLogger)
...
func (m *MockNewsletterSender) MultipleSending(arg0 []string, arg1 *domain.EmailMessage) ([]string, error) {
	m.ctrl.T.Helper()
